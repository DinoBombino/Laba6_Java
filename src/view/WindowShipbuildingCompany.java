...
public class WindowShipbuildingCompany {
    ...
    public WindowShipbuildingCompany(JFrame jFrame, TheTableModel myTableModel) {
        this.myTableModel = myTableModel;
        this.dialog = new JDialog(jFrame, "Таблица судостроительных компаний", true);
    ...
    public void initListeners() {
        button_add.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                new AddShipbuildingCompany(dialog);
                Group.sortList(3);
