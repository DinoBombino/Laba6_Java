...
public class WindowInsuranceCompany {
    ...
    public WindowInsuranceCompany(JFrame jFrame, TheTableModel myTableModel) {
        this.myTableModel = myTableModel;
        this.dialog = new JDialog(jFrame, "Таблица страховых компаний", true);
    ...
    public void initListeners() {
        button_add.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                new AddInsuranceCompany(dialog);
                Group.sortList(1);
