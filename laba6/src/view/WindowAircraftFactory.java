...
public class WindowAircraftFactory {
    ...
    public WindowAircraftFactory(JFrame jFrame, TheTableModel myTableModel) {
        this.myTableModel = myTableModel;
        this.dialog = new JDialog(jFrame, "Таблица авиазаводов", true);
